...
class UserDetail(User):
    ...
    def get_profile_vote_num(self):
        """
            个人成就--获得赞同数量
        """
        return self.base_profile_num()

    def get_profile_thank_num(self):
        """
            个人成就--获得感谢数量
        """
        return self.base_profile_num(i=1)

    def get_profile_fav_num(self):
        """
            个人成就--获得收藏数量
        """
        return self.base_profile_num(i=2)

    def get_profile_fav_share(self):
        """
            个人成就--获得收藏数量
        """
